...
function loadProducts() {
    try {
        ...
        if (!stored) {
            const defaults = [
                // --- Kategori: Coffee ---
                { id: 1, name: "Stigma Aren Latte", price: 28000, stock: 50, category: "coffee", img: "https://images.unsplash.com/photo-1541167760496-1628856ab772?w=500&q=80" },
                { id: 2, name: "V60 Gayo Wine", price: 32000, stock: 15, category: "coffee", img: "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=500&q=80" },
                { id: 3, name: "Cappuccino", price: 25000, stock: 30, category: "coffee", img: "https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=500&q=80" },
                { id: 4, name: "Caramel Macchiato", price: 30000, stock: 25, category: "coffee", img: "https://images.unsplash.com/photo-1485808191679-5f8c7c41f7bc?w=500&q=80" },

                // --- Kategori: Non-Coffee ---
                { id: 10, name: "Matcha Fusion", price: 29000, stock: 40, category: "non-coffee", img: "https://images.unsplash.com/photo-1515825838458-f2a94b20105a?w=500&q=80" },
                { id: 11, name: "Red Velvet Latte", price: 27000, stock: 35, category: "non-coffee", img: "https://images.unsplash.com/photo-1563222384-5f5f4d1e3957?w=500&q=80" },
                { id: 12, name: "Lychee Tea", price: 18000, stock: 50, category: "non-coffee", img: "https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=500&q=80" },
                { id: 13, name: "Chocolate Signature", price: 26000, stock: 45, category: "non-coffee", img: "https://images.unsplash.com/photo-1542990253-0d0f5be5f0ed?w=500&q=80" },

                // --- Kategori: Pastry & Snack ---
                { id: 20, name: "Croissant Almond", price: 22000, stock: 20, category: "pastry", img: "https://images.unsplash.com/photo-1554230607-b23547468c4a?w=500&q=80" },
                { id: 21, name: "Choco Muffin", price: 18000, stock: 15, category: "pastry", img: "https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=500&q=80" },
                { id: 22, name: "French Fries", price: 20000, stock: 30, category: "pastry", img: "https://images.unsplash.com/photo-1630384060421-cb20d0e0649d?w=500&q=80" },
                { id: 23, name: "Mix Platter", price: 35000, stock: 10, category: "pastry", img: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=500&q=80" }
            ];
            
            // Simpan ke LocalStorage agar Owner juga bisa melihat/mengedit ini
            localStorage.setItem('stigma_products', JSON.stringify(defaults));
            return defaults;
        }
...
function renderProducts(items) {
    ...
    items.forEach(product => {
        ...
        const imgUrl = product.img && product.img.length > 5 ? product.img : "https://via.placeholder.com/300?text=No+Image";
        ...
        div.innerHTML = `
            <div class="h-36 w-full rounded-xl bg-gray-100 mb-4 overflow-hidden relative">
                <img src="${imgUrl}" class="w-full h-full object-cover ${!isOut ? 'group-hover:scale-110 transition duration-700' : ''}">
                ${!isOut ? `
...
function updateCartUI() {
    ...
    app.cart.forEach(item => {
        ...
        div.innerHTML = `
            <img src="${item.img || 'https://via.placeholder.com/100'}" class="w-14 h-14 rounded-lg object-cover bg-gray-100">
...
function showModal() {
    ...
    try {
        // 1. Ambil data Owner
        const ownerProducts = JSON.parse(localStorage.getItem('stigma_products') || '[]');
        ...
        localStorage.setItem('stigma_products', JSON.stringify(ownerProducts));
